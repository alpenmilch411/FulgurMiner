...
/**
 * Max encoded size of a single transaction (bytes). Transfers are 152 B and
 * Locks 156 B, but a Redeem is variable: worst case =
 *   REDEEM_OVERHEAD(87) + MAX_SCRIPT_BYTES(10_000) + MAX_WITNESS_ITEMS(100)*(2+MAX_PUSH_BYTES(520))
